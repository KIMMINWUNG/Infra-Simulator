...
// 역할: 좌측의 설정 및 파일 업로드 UI (애니메이션 추가)
// =================================================================
...
export default function ControlPanel({
    ...
    return (
        ...
        >
            {/* Info Banner */}
            <motion.div variants={cardVariants} className="bg-blue-50 border-l-4 border-blue-400 text-blue-800 p-4 rounded-r-lg" role="alert">
                <div className="flex">
                    <div className="py-1">
